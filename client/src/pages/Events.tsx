...
const FALLBACK_EVENTS = [
  { _id: "1", title: "HACKATHON 2026", date: "2026-03-15", location: "KITSW Campus", category: "Hackathon", status: "upcoming", shortDescription: "36-hour coding marathon with sustainability theme.", maxParticipants: 300, registrationLink: "#", tags: ["coding", "ai"], coverImage: "https://picsum.photos/seed/hack26/800/400" },
  { _id: "2", title: "AI WORKSHOP SERIES", date: "2025-11-28", location: "Seminar Hall", category: "Workshop", status: "completed", shortDescription: "Hands-on sessions on LLMs and transformers.", registeredCount: 95, tags: ["ai", "ml"], coverImage: "https://picsum.photos/seed/aiws/800/400" },
  { _id: "3", title: "HACKATHON 2025", date: "2025-10-15", location: "KITSW Campus", category: "Hackathon", status: "completed", shortDescription: "36-hour marathon — 180 participants, 30 teams.", registeredCount: 180, tags: ["hackathon"], coverImage: "https://picsum.photos/seed/hack25/800/400", winners: [{ position: "1st", name: "Team Alpha", prize: "₹15,000" }, { position: "2nd", name: "Team Beta", prize: "₹10,000" }] },
  { _id: "4", title: "GUEST LECTURE: FUTURE OF WEB", date: "2026-03-05", location: "Auditorium", category: "Guest Lecture", status: "upcoming", shortDescription: "Expert talk on WebAssembly and edge computing.", tags: ["web"], coverImage: "https://picsum.photos/seed/weblec/800/400" },
  { _id: "5", title: "CODE SPRINT 2025", date: "2025-09-05", location: "CS Lab Complex", category: "Competition", status: "completed", shortDescription: "Competitive programming contest with prizes.", registeredCount: 120, tags: ["competitive"], coverImage: "https://picsum.photos/seed/cs25/800/400" },
  { _id: "6", title: "IOT BOOTCAMP", date: "2026-04-05", location: "Electronics Lab", category: "Workshop", status: "upcoming", shortDescription: "2-day hands-on IoT bootcamp with hardware.", maxParticipants: 60, registrationLink: "#", tags: ["iot"], coverImage: "https://picsum.photos/seed/iotbc/800/400" },
];
